<div id="slider_row" class="row">
    <div id="top_column" class="center_column col-xs-12">
        <div id="homepage-slider">
            <ul id="homeslider" style="max-height:531px;">

                @forelse($sliderData as $data)
                    <li class="homeslider-container">
                        <a href="https://www.oliverweber.com/en/638-jewelry?collection=winter-2019"
                           title="Winter 2019 Collection">
                            <img src="{{url()->to('/storage')."/".$data['path']}}"
                                    width="1920" height="531" alt="{{$data['title']}}"/>
                        </a>
                    </li>
                @endforelse
            </ul>
        </div>
        <span id="amazonpay_tooltip" style="display: none;">
