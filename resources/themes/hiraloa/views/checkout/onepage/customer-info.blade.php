...
<hr>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="checkout-form-list"
                    ...
                    <input placeholder="" v-validate="'required'"
            ...
            <div class="col-md-6">
                <div class="checkout-form-list"
                    ...
                    <input id="billing[last_name]" v-validate="'required'"
            ...
            <div class="col-md-12">
                <div class="checkout-form-list">
                    ...
                    <input type="text" v-validate="'required'" class="control" id="billing_address_0"
            ...
            <div class="col-md-6">
                <div class="checkout-form-list">
                    ...
                    <input type="text" v-validate="'required'" class="control" id="billing[postcode]"
    ...
    <div class="form-container different-address checkbox-form" v-if="!address.billing.use_for_shipping && this.new_shipping_address">
        <div class="row">
        ...
        <div class="ship-different-title">
            ...
            <div class="col-md-12" >
                <div class="country-select clearfix" :class="[errors.has('address-form.shipping[country]') ? 'has-error' : '']">
                    <label for="shipping[country]" class="required">
                        {{ __('shop::app.checkout.onepage.country') }} <span class="required">*</span></label>
                    <select name="shipping[country]" v-validate="'required'" id="shipping[country]"
                            class="myniceselect nice-select wide"
                            v-model="address.shipping.country" data-vv-as="&quot;{{ __('shop::app.checkout.onepage.country') }}&quot;">
            ...
            <div class="col-md-6">
                <div class="checkout-form-list" :class="[errors.has('address-form.shipping[first_name]') ? 'has-error' : '']">
            ...
            <div class="col-md-6">
                <div class="checkout-form-list" :class="[errors.has('address-form.shipping[last_name]') ? 'has-error' : '']">
                    <label for="shipping[last_name]"
                           class="required">{{ __('shop::app.checkout.onepage.last-name') }} <span class="required">*</span></label>
            ...
            <div class="col-md-12">
                <div class="checkout-form-list" :class="[errors.has('address-form.shipping[email]') ? 'has-error' : '']">
            ...
            <div class="col-md-12">
                <div class="checkout-form-list" :class="[errors.has('address-form.shipping[address1][]') ? 'has-error' : '']">
            ...
            <div class="col-md-6">
                <div class="checkout-form-list" :class="[errors.has('address-form.shipping[state]') ? 'has-error' : '']">
            ...
            <div class="col-md-6">
                <div class="checkout-form-list" :class="[errors.has('address-form.shipping[phone]') ? 'has-error' : '']">
