<form method="POST" class="form-horizontal"
    ...
    <div class="form-group ">
        <div class="col-sm-12 p-0">
            ...
            <input value="{{ old('title') }}" class="review-input form-control" type="text" name="title" id="con_email" required>
        </div>
    </div>
        ...
        <div class="form-group required">
            <div class="col-sm-12 p-0">
                ...
                <input value="{{ old('name') }}" class="review-input form-control" type="text" name="name" id="con_email" required>
            </div>
        </div>
    ...
    <div class="form-group required second-child">
        <div class="col-sm-12 p-0">
            ...
            <textarea class="review-textarea form-control" name="comment" id="con_message">{{ old('comment') }}</textarea>
