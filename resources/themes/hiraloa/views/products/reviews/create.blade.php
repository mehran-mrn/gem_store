                ...
                <div class="review-layouter mb-20">
                    ...
                    <div class="review-form">
                        <form method="POST" class="form-horizontal"
                            ...
                            <div class="control-group form-group last-child required"
                                 :class="[errors.has('rating') ? 'has-error' : '']">
                                <div class="your-opinion">
                                    ...
                                    <div class="stars">
                                        <span class="star star-5" for="star-5" onclick="calculateRating(id)"
                                              id="1"></span>
                                        <span class="star star-4" for="star-4" onclick="calculateRating(id)"
                                              id="2"></span>
                                        <span class="star star-3" for="star-3" onclick="calculateRating(id)"
                                              id="3"></span>
                                        <span class="star star-2" for="star-2" onclick="calculateRating(id)"
                                              id="4"></span>
                                        <span class="star star-1" for="star-1" onclick="calculateRating(id)"
                                              id="5"></span>
                                    </div>

                                    <input type="hidden" id="rating" name="rating" v-validate="'required'">

                                    <div class="control-error" v-if="errors.has('rating')">@{{ errors.first('rating') }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="control-group form-group required">
                                <label for="title" class="required">{{ __('shop::app.reviews.title') }}</label>
                                <input type="text" name="title" v-validate="'required'"
                                       value="{{ old('title') }}">
                            ...
                            <div class="control-group" :class="[errors.has('comment') ? 'has-error' : '']">
                                ...
                                <textarea type="text" class="review-textarea" name="comment" v-validate="'required'"
                                          value="{{ old('comment') }}">
                        </textarea>
                                <span class="control-error"
                                      v-if="errors.has('comment')">@{{ errors.first('comment') }}</span>
                            </div>
