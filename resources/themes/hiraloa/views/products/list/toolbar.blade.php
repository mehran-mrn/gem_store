...
<div class="shop-toolbar" style="border-radius: 10px!important;">
    <div class="product-item-selection_area">
        <div class="product-short mr-2" style="border-radius: 10px!important;">
    ...
    <div class="product-view-mode">
        <a href="{{$toolbarHelper->isModeActive('grid')? "": $toolbarHelper->getModeUrl('grid')}}"
           class="{{$toolbarHelper->isModeActive('grid')? "active":""}} grid-3" data-target="gridview-3"
           data-toggle="tooltip" data-placement="top" title="پنجره ای"><i class="fa fa-th"></i></a>
        <a href="{{$toolbarHelper->isModeActive('list')? "":$toolbarHelper->getModeUrl('list')}}"
           class="{{$toolbarHelper->isModeActive('list')? "active":""}} list" data-target="listview"
           data-toggle="tooltip" data-placement="top" title="لیست"><i class="fa fa-th-list"></i></a>
