...
return [
    ...
    'header' => [
        ...
        'cart' => 'سبد خرید',
        'logout' => 'خروج',
        'search-text' => 'جستجو در بین محصولات'
    ],
    ...
    'subscription' => [
        ...
        'subscribe' => 'اشتراک در',
        'subscribed' => 'ایمیل شما به عنوان مشترک ثبت شده است',
        'not-subscribed' => 'اشتراک انجام نشد مجددا تلاش کنید.',
        'already' => 'ایمیل شما در لیست مشترکین ثبت شده است',
        'unsubscribed' => 'اشتراک خبرنامه لغو شد',
        'already-unsub' => 'شما قبلاً لغو اشتراک شده اید',
        'not-subscribed' => 'خطا! نامه ارسال نمی شود، لطفا بعدا دوباره امتحان کنید'
    ],
    ...
    'reviews' => [
        'title' => 'عنوان',
        'add-review-page-title' => 'افزودن نظر',
        'write-review' => 'نظر خود را بنویسید',
        'review-title' => 'عنوان',
        'product-review-page-title' => 'نظرات کاربران',
        'rating-reviews' => 'رتبه بندی و بررسی',
        'submit' => 'ارسال',
        'delete-all' => 'حذف همه نظرات',
    ...
    'customer' => [
        'signup-text' => [
            'account_exists' => 'حساب کاربری دارید؟ ',
            'title' => 'ورود'
        ],

        'signup-form' => [
            'page-title' => 'فرم ثبت نام',
            'title' => 'ثبت نام',
            'firstname' => 'نام',
            ...
            'success-verify' => 'حساب کاربری با موفقیت ایجاد شد ، نامه الکترونیکی برای تأیید ارسال شده است.',
            'success-verify-email-unsent' => 'حساب کاربری با موفقیت ایجاد شد ، اما نامه الکترونیکی تأیید نشده است',
            'failed' => 'خطا! نمی توانید حساب خود را ایجاد کنید ، بعدا دوباره امتحان کنید',
            'already-verified' => 'حساب کاربری شما قبلا تایید شده است',
            'verification-not-sent' => 'خطا! کد تاییده ارسال نشد',
            'verification-sent' => 'ایمیل تأیید ارسال شده است',
            'verified' => 'حساب شما تأیید شده است ، میتوانید وارد سیستم شوید',
        ...
        'login-form' => [
            ...
            'verify-first' => 'ابتدا ایمیل خود را تأیید کنید',
            'not-activated' => 'فعال سازی شما در انتظار تأیید سرپرست است',
            'resend-verification' => 'مجدداً کد تأیید را ارسال کنید'
        ],
        ...
        'reset-password' => [
            ...
            'back-link-title' => 'بازگشت به صفحه ورود به سیستم',
            'submit-btn-title' => 'بازیابی رمز'
        ],
    ...
    'checkout' => [
        ...
        'onepage' => [
            ...
            'city' => 'شهر',
            'state' => 'استان',
            'select-state' => 'استان را انتخاب نمایید',
            'postcode' => ' کدپستی',
            'phone' => 'تلفن',
            'country' => 'کشور',
            'order-summary' => 'خلاصه سفارش',
            'shipping-address' => 'آدرس حمل و نقل',
            'use_for_shipping' => 'به همین آدرس ارسال شود',
            'continue' => 'ادامه هید',
        ...
        'total' => [
            ...
            'coupon' => 'کد تخفیف',
            'coupon-applied' => 'کد تخفیف کاربردی',
