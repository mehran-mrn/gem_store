...
return [
    ...
    'dashboard' => [
        ...
        'from' => 'از',
        'to' => 'به',
        'total-customers' => 'تعداد کل مشتریان',
    ...
    'datagrid' => [
        ...
        'price' => 'قیمت',
        'qty' => 'مقدار',
        'locale-based'=>'محصول محلی',
        'channel-based'=>'محصول کانال',
    ...
    'users' => [
        ...
        'users' => [
            ...
            'current-password' => 'رمز عبور فعلی را وارد کنید',
            ...
            'incorrect-password' => 'رمز وارد شده اشتباه است',
            'password-match' => 'رمز فعلی مطابقت ندارد.',
            'account-save' => 'تغییرات حساب با موفقیت ذخیره شد.',
            'login-error' => 'اطلاعات صحیح نیست، لطفا دوباره امتحان کنید.',
            'activate-warning' => 'حساب شما فعال نشده.'
        ],
    ...
    'sales' => [
        ...
        'shipments' => [
            ...
            'save-btn-title' => 'تایید و ذخیره اطلاعات',
            'qty-ordered' => 'سفارش داده شده',
            'qty-to-ship' => 'مقدار ارسالی',
            'available-sources' => 'منابع موجود',
            'source' => 'تامین کننده',
            'select-source' => 'لطفا تامین کننده را انتخاب کنید',
            ...
            'creation-error' => 'امکان ایجاد سند ارسال برای این سفارش وجود ندارد.',
